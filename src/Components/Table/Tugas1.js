        ...
        fetch("https://sheet.best/api/sheets/06e48920-0b01-4467-8712-40a119aaa360")
            ...
            .then((data) => {
                ...
                const filteredData = data.filter((item) =>
                    item.tugas_ke.toLowerCase() === 'tugas 1'
                );
                setData(filteredData);
                setFilteredData(filteredData);
                setTotalData(filteredData.length); // This line might be redundant now
            })
    ...
    return (
        <div>
            <div className='title' style={{display:'flex', justifyContent:'space-between'}}>
                <h4 className='mb-4'>Rekap pengumpulan Tugas 1</h4>
